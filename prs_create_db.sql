...
-- insert some rows into the Purchase Request table
INSERT into purchaserequest (ID, UserID, Description, Justification, DateNeeded, DeliveryMethod, Status, Total, SubmittedDate, ReasonForRejection) VALUES
(1, 2, 
